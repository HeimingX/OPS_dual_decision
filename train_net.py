...
from lib import (DatasetMapper, DatasetMapperOrigin, DatasetMapperOracleVerify, add_config,
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):        
        if cfg.DATASETS.ONLINE_PROCESS_UNK:
            mapper = DatasetMapperOrigin(cfg, True)
        elif cfg.DATASETS.UNK_ORACLE_VERIFY:
            mapper = DatasetMapperOracleVerify(cfg, True)
        else:
